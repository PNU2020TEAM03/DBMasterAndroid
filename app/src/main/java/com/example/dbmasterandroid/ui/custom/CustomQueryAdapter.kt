...
class CustomQueryAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position == 0) {
            when (columnNames.size) {
                1 -> setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                2 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                }
                3 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    setColumnName(holder.itemView.table_row_data3, columnNames, 2)
                }
                4 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    setColumnName(holder.itemView.table_row_data3, columnNames, 2)
                    setColumnName(holder.itemView.table_row_data4, columnNames, 3)
                }
                5 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    setColumnName(holder.itemView.table_row_data3, columnNames, 2)
                    setColumnName(holder.itemView.table_row_data4, columnNames, 3)
                    setColumnName(holder.itemView.table_row_data5, columnNames, 4)
                }
                6 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    ...
                    setColumnName(holder.itemView.table_row_data4, columnNames, 3)
                    setColumnName(holder.itemView.table_row_data5, columnNames, 4)
                    setColumnName(holder.itemView.table_row_data6, columnNames, 5)
                }
                7 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    ...
                    setColumnName(holder.itemView.table_row_data5, columnNames, 4)
                    setColumnName(holder.itemView.table_row_data6, columnNames, 5)
                    setColumnName(holder.itemView.table_row_data7, columnNames, 6)
                }
                8 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    ...
                    setColumnName(holder.itemView.table_row_data6, columnNames, 5)
                    setColumnName(holder.itemView.table_row_data7, columnNames, 6)
                    setColumnName(holder.itemView.table_row_data8, columnNames, 7)
                }
                9 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    ...
                    setColumnName(holder.itemView.table_row_data7, columnNames, 6)
                    setColumnName(holder.itemView.table_row_data8, columnNames, 7)
                    setColumnName(holder.itemView.table_row_data9, columnNames, 8)
                }
                10 -> {
                    setColumnName(holder.itemView.table_row_data1, columnNames, 0)
                    setColumnName(holder.itemView.table_row_data2, columnNames, 1)
                    ...
                    setColumnName(holder.itemView.table_row_data8, columnNames, 7)
                    setColumnName(holder.itemView.table_row_data9, columnNames, 8)
                    setColumnName(holder.itemView.table_row_data10, columnNames, 9)
                }
            }
        } else {
    ...
    private fun setColumnName(textView: TextView, columnName: MutableSet<String>, position: Int) {
        textView.apply {
            visibility = View.VISIBLE
            text = columnName.elementAt(position)
        }
    }
}